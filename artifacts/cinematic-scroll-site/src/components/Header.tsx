      ...
      <div className="flex items-center gap-2 sm:gap-3 pl-10 sm:pl-16 ml-auto z-20 shrink-0">
        ...
        {currentUser ? (
          ...
          <button
            ...
            className="group relative flex items-center gap-2 px-5 h-10 rounded-full font-['Plus_Jakarta_Sans',sans-serif] font-bold text-xs sm:text-sm tracking-wide transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer text-slate-950 bg-white hover:bg-slate-100 shadow-[0_4px_20px_rgba(255,255,255,0.2)] border border-white/80 overflow-hidden shrink-0"
          >
