...
function TypewriterGradientText({
  ...
  return (
    <span className="relative inline-block whitespace-nowrap">
      <span className="bg-clip-text text-transparent bg-gradient-to-r from-white via-[#E0F7FA] to-[#00E5D1] inline-block font-black whitespace-nowrap drop-shadow-[0_0_25px_rgba(0,229,209,0.5)] tracking-wide">
        {displayedText || "\u00A0"}
      </span>
      {isTyping && (
        <span
          className="inline-block w-[3px] h-[0.8em] ml-1 bg-[#00E5D1] align-middle rounded-full animate-pulse"
          style={{
              ...
              >
                <div className="relative w-full h-full flex items-center">
                  ...
                  <button
                    ...
                    className={`absolute right-3.5 w-7 h-7 flex items-center justify-center rounded-full transition-all cursor-pointer text-white hover:bg-white/10 ${searchVal ? "opacity-60 hover:opacity-100" : "opacity-0 pointer-events-none"}`}
